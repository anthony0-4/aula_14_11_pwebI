...
CREATE TABLE IF NOT EXISTS `aluno` (
  ...
  `cpf` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Copiando dados para a tabela db_aula_pweb1.aluno: ~3 rows (aproximadamente)
INSERT INTO `aluno` (`id`, `nome`, `telefone`, `cpf`) VALUES
	(1, 'teste', '888888888888', 2222),
	(6, 'aaa', '2222', 222),
	(7, 'aaa', '343433', 222);
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `cpf` varchar(14) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `email` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `senha` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`id`)
